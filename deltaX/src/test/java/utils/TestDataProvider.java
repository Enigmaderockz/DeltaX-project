...
public class TestDataProvider {
	...
	public Object[][] getData() throws Exception {
		...
		int numberOfCellInARow = excelDriver.getCellCount(sheetName, 0);
		System.out.println(numberOfCellInARow);

		data = new Object[numberOfRows +1 ][numberOfCellInARow];

		for (int iRow = 0; iRow < numberOfRows+1; iRow++) {

			for (int iCell = 0; iCell < numberOfCellInARow; iCell++) {

				data[iRow][iCell] = excelDriver.getCellData(sheetName, iRow, iCell);
